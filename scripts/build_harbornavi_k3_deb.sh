...
release_label="${RELEASE_VERSION:-harbornavi-local-vision-p0-${date_stamp}+riscv64}"
debian_version="${DEBIAN_VERSION:-0.1.0+harbornavi.localvision.p0.${date_stamp}.riscv64}"
